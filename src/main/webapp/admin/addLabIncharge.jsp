<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
        <%@ page import="com.dao.LaboratoryDao" %>
    <%@ page import="com.db.DBConnect" %>
    <%@ page import="com.entity.Laboratory" %>
    <%@ page import="java.util.List" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Add LabIncharge</title>
	 ...
	 <div class="container login-container">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="login-box">
                    <h2 class="text-center">Lab Incharge Register</h2>
                    <form action="../labInc_register" method="post" id="passwordForm">
                        ...
                        <div class="form-group position-relative">
                            ...
                            LaboratoryDao dao = new LaboratoryDao(DBConnect.getConn());
             			      List<Laboratory> list1 =dao.getAllLab();
             			      for(Laboratory  s:list1){
             			    	  
             			      %>
             			  
                            <option><%=s.getLab_name() %></option>
                            <%}
                            %>
                            </select>
